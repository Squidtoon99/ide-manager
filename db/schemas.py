...
from .models import Assignment, Course, File, Project, School, User, Unit, DeploymentVersion
...
class ProjectSchema(ma.SQLAlchemyAutoSchema):
    ...
    assignment = ma.Nested("AssignmentSchema")
...
class DeploymentVersionSchema(ma.SQLAlchemyAutoSchema):
    class Meta:
...
deployment_version_schema = DeploymentVersionSchema()
